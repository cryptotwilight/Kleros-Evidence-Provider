...
var chain = {};
chain.name = 'Kovan Test Network';
chain.id =  42;
chain.rpcUrls = ['https://kovan.infura.io/v3/'];
chain.blockExplorerUrls = ['https://kovan.etherscan.io'];
var nativeCurrency = {}; 
nativeCurrency.name = 'KovanETH';
nativeCurrency.decimals = 18;
nativeCurrency.symbol = 'KovanETH';
chain.nativeCurrency = nativeCurrency; 
